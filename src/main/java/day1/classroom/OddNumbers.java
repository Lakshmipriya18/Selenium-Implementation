...
public class OddNumbers {
	 ...
	 * 
	 * 1)I have learned the looping concepts 
	 * 2)I have understood the conditional statements and control statements based on the scenarios
	 * 3)
	 * 
	 */
	...
	public static void main(String[] args) {
       ...
       //	Within loop -> print the odd integer
				System.out.println("Print the odd integer "+i);
			}
		}
